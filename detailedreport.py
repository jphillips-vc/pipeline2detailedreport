...
def genXML():
	...
	sub_sev_el_1.set('categoryname', '')
	sub_sev_el_1.set('pcirelated', '')
	...
	sub_cat_el_3.set('pcirelated', '999')
	...
	for x in flaws:
		...
		sub_sub_cwe_el_2.set('note', 'na')
		sub_sub_cwe_el_2.set('pcirelated', 'na')
